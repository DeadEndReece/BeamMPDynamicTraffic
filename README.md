...
To use this properly with CareerMP, Make sure you have traffic settings DISABLED in base CareerMP, You can use the `Parked Cars` just dont have normal traffic enabled!
